...
import {BsBell, BsChevronDown, BsSearch, BsSearchHeart} from "react-icons/bs";
            ...
            <div className={`
                ...
                <div className="flex flex-row ml-auto gap-7 items-center">
                    ...
                    <div onClick={toggleAccountMenu}  className="flex flex-row items-center gap-2 cursor-pointer relative">
                        ...
                        <BsChevronDown className={`text-white transition ${showAccountMenu?'rotate-0' : 'rotate-90'}`} />
